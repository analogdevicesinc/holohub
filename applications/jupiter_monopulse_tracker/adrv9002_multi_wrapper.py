...
class adrv9002_multi(map_to_multi_devices, adrv9002):
    ...
    def __init__(
        ...
        self.pcal_data = [0.0 for i in range(0, self.num_cal_elements)]
        self.gcal_data = [0.0 for i in range(0, self.num_cal_elements)]
    ...
    def load_gain_cal(self, filename="gain_cal_val.pkl"):
        ...
        try:
            with open(filename, "rb") as file:
                ...
                file.close()
                print("Loaded gain caibration values")
            print("Gain calibration values loaded")
    ...
    def load_phase_cal(self, filename="phase_cal_val.pkl"):
        ...
        try:
            with open(filename, "rb") as file:
                ...
                file.close()
                print("Loaded phase calibration values")
            print("Phase calibration values loaded")
        except FileNotFoundError:
            print("file not found, loading default (no phase shift)")
