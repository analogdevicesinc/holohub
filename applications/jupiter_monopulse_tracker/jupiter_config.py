...
ANTENNA_SETUP = True  # Set to False to use power splitter setup
POWER_SPLITTER_MODE = not ANTENNA_SETUP
...
if ANTENNA_SETUP:
    lo_freq = 5400000000 - 300000 # [Hz] LO frequency of jupiter
    ...
    number_periods_sine_baseband = 200
    lambda_over_d_spacing = 1.93 # for Rx phased array antenna 
...
elif POWER_SPLITTER_MODE: # For Power splitter setup:
